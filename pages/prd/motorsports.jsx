  ...
  return (
    <div className="w-full min-h-screen text-light-gray overflow-x-hidden relative bg-[#050505]">
      ...
      <main className="w-full max-w-4xl mx-auto px-4 py-32 relative z-10">
        ...
        >
          <div className="mb-4 text-neon-cyan font-mono text-sm uppercase tracking-widest">
          ...
          <div className="flex gap-4 mb-12">
            <span className="text-light-gray/60 font-mono text-sm border border-white/10 bg-white/5 px-3 py-1 rounded">Status: In Development</span>
            <span className="text-light-gray/60 font-mono text-sm border border-white/10 bg-white/5 px-3 py-1 rounded">Author: Haresh Murugesan</span>
          </div>

          <div className="space-y-12 font-sans">
            <section className="bg-black/40 backdrop-blur-md border border-white/10 rounded-2xl p-8 shadow-lg shadow-black/50">
              <h2 className="text-2xl font-mono font-bold text-white mb-4">1. Executive Summary</h2>
            ...
            <section>
              <h2 className="text-2xl font-mono font-bold text-neon-cyan mb-4">2. Objectives & Success Metrics</h2>
            ...
            <section>
              <h2 className="text-2xl font-mono font-bold text-neon-cyan mb-4">3. System Architecture</h2>
              ...
              <div className="bg-black/60 border border-white/10 rounded-xl p-6 font-mono text-sm overflow-x-auto">
                <div className="flex flex-col gap-6 min-w-[700px]">
                  ...
                  <div className="flex items-center gap-4">
                    ...
                    <div className="text-neon-cyan">→</div>
                    <div className="bg-white/5 p-3 rounded border border-neon-cyan/50 text-neon-cyan shadow-[0_0_10px_rgba(0,255,255,0.2)] flex-1">
            ...
            <section>
              <h2 className="text-2xl font-mono font-bold text-neon-cyan mb-4">4. Core Features & Epics</h2>
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div className="bg-black/40 border border-white/10 rounded-xl p-6">
                  <h3 className="text-lg font-mono font-bold text-white mb-2">Live Race Command Center</h3>
                ...
                <div className="bg-black/40 border border-white/10 rounded-xl p-6">
                  <h3 className="text-lg font-mono font-bold text-white mb-2">AI Strategy Oracle</h3>
                ...
                <div className="bg-black/40 border border-white/10 rounded-xl p-6">
                  <h3 className="text-lg font-mono font-bold text-white mb-2">Radio Transcription Engine</h3>
                ...
                <div className="bg-black/40 border border-white/10 rounded-xl p-6">
                  <h3 className="text-lg font-mono font-bold text-white mb-2">Multi-Discipline Database</h3>

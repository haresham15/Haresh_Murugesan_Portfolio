...
>
  ...
  <div className="max-w-4xl mx-auto text-center">
    ...
    {/* Email Button */}
      <a href="mailto:haresham2006@gmail.com" target="_blank" rel="noopener noreferrer" className="bg-gray-800 text-white px-6 py-3 z-10 p-2 rounded-md hover:bg-teal-500 transition text-center" onClick={(e) => e.stopPropagation()} >Email Me </a>
      {/* LinkedIn Button */}
      <a href="https://www.linkedin.com/in/haresh-murugesan-4173412a1/" target="_blank" rel="noopener noreferrer" className="bg-gray-800 z-10 p-2 text-white px-6 py-3 rounded-md hover:bg-teal-500 transition text-center" onClick={(e) => e.stopPropagation()}> Connect on LinkedIn </a>
</div>
  </div>
</motion.div>
